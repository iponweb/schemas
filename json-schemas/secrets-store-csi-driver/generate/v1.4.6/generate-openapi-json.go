...
const (
	kubernetesSwaggerUrl = "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.31.3/api/openapi-spec/swagger.json"
)
...
var (
	...
	crdNames = []string{
		"github.com/kubernetes-sigs/secrets-store-csi-driver/apis/v1.SecretProviderClass",
		"github.com/kubernetes-sigs/secrets-store-csi-driver/apis/v1.SecretProviderClassPodStatus",
		"github.com/kubernetes-sigs/secrets-store-csi-driver/apis/v1alpha1.SecretProviderClass",
		"github.com/kubernetes-sigs/secrets-store-csi-driver/apis/v1alpha1.SecretProviderClassPodStatus",
	}

	hostConversionRules = map[string]string{
		"github.com/kubernetes-sigs/secrets-store-csi-driver": "secrets-store.csi.x-k8s.io",
	}
)
